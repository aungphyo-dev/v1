                ...
                <div className="min-h-screen flex flex-col justify-start md:justify-center items-center flex-wrap">
                    <div className='w-full flex justify-center items-center flex-wrap'>
                        <motion.div initial={{ opacity: 0,y:-200}}
                                    ...
                                    className="w-full lg:w-2/4 px-3 pt-3">
                            <div className='flex justify-start items-start mx-auto gap-x-[0.1rem] md:gap-x-4'>
                                ...
                                <div className='mt-5'>
                                    <h1 className='text-gray-700 dark:text-gray-300 text-4xl font-bold tracking-wide mb-5'>Hi, I'm <span className='text-blue-500'>Typle</span> </h1>
                                    <div className='text-gray-700 dark:text-gray-300 text-xl md:text-2xl tracking-wide leading-9 mb-3 '>I am a <ReactTypingEffect
                                        speed={90}
                                        eraseDelay={90}
                                        typingDelay={90}
                                    ...
                                    />
                                        ...
                                        interfaces and web applications</div>
                                    ...
                                    <a href='../assets/aungpyaephyocv.pdf' download='' className=' text-white bg-blue-500 py-2 rounded flex items-center justify-center w-52 hover:bg-blue-900'> Download cv <AiOutlineArrowDown className='ml-1'/></a>
                                </div>
                            </div>
                        </motion.div>
                        <motion.div
