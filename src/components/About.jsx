...
const About = () => {
    return (
        <>
            <section
                className="bg-white dark:bg-gray-900 pt-[80px]  lg:pt-0"
                id="about"
            >
                        ...
                        <div className="w-full  text-center">
                            <div className="text-center w-full my-5">
                                <motion.h1
                                    ...
                                    className="text-md text-gray-800 dark:text-gray-400 mb-2"
                                >
                                    My abilities
                                </motion.h1>
                                <motion.h1
                        ...
                        <div className="w-full flex items-center lg:items-start flex-wrap flex-col-reverse lg:flex-row">
                            <div className="w-full lg:w-[35%]">
                                <motion.img
                                    ...
                                    whileInView={{opacity: 1, y: 0}}
                                    src={AboutPic}
                                    className="h-auto w-full  rounded-xl lg:h-[350px] mx-auto lg:w-[500px] object-cover obj-po"
                                    alt=""
                                />
                            </div>
