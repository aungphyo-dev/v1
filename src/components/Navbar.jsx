...
const Navbar = () => {
    ...
    return(
        <motion.nav
            ...
            <div className="hover:rounded-b-[3rem] transition-[border-radius] duration-500  container flex flex-wrap shadow-md items-center justify-between mx-auto bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
                <Link to='/'  onClick={homeGoHandler} className="flex items-center">
                    <img src={Logo} className="h-6 mr-3 sm:h-9"
                         alt="Logo"/>
                    <span
                        className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Typle X</span>
                </Link>
                ...
                <div className={`items-center justify-between ${open?"hidden":"block"} w-full md:flex md:w-auto md:order-1`}
                    ...
                    <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 uppercase">
                        <li onClick={()=>setOpen(true)}>
                            <a href="#home"
                               className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
                        </li>
                        <li onClick={()=>setOpen(true)}>
                            <a href="#about"
                        ...
                        <li onClick={()=>setOpen(true)}>
                            <a href="#projects"
                               className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Projects</a>
                        </li>
                        <li onClick={()=>setOpen(true)}>
                            <a href="#contact"
