...
const Contact = () => {
    ...
    const handleSubmit = async (e)=>{
        ...
        await axios.post("https://formspree.io/f/mrgvybye",{
            data
        });
        setName('')
        setEmail('')
        ...
        <>
            ...
            whileInView={{ opacity: 1,y:0  }}
                                        ...
                                        <div className="ml-4 overflow-x-hidden">
                                            ...
                                            <a href='mailto:aungpyaephyo1412@gmail.com' className="mt-2 text-sm text-gray-500 dark:text-gray-400 truncate">aungpyaephyo1412@gmail.com</a>
                                        </div>
                                    </motion.div>
                                    <motion.div
                                        initial={{ opacity: 0,y:50}}
                            ...
                            <div
                                ...
                                <form autoComplete='off' className='bg-form p-3 md:p-5 rounded-lg shadow-md dark:bg-gray-700' onSubmit={handleSubmit}>
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.5 ,delay:0.1,velocity:easeIn}}
                                        whileInView={{ opacity: 1,y:0  }}
                                        className='text-center font-semibold text-2xl uppercase text-gray-600 dark:text-gray-200 pb-5'>
                                        Get in touch
                                    </motion.div>
